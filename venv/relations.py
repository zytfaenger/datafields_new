...
def l_update_relation(admin_user, relation_id_to_change='=', giver_uuid='=', receiver_uuid='=', type_of_access='=',admin_active='='):
        ...
        cursor.execute(query, (giver_uuid,receiver_uuid,type_of_access,current_admin_user, current_timestamp, previous_log_entry, admin_active, relation_id_to_change))
        cursor3.commit()
